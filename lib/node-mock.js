...
// be sent.
//
function sendMessage(node, message, args, cb) {
    var res = false;
...
exports.NodeMock.prototype.ping = function(endpoint, cb) {
    sendMessage(this._network._nodes[endpoint], 'ping', endpoint, [], cb);
};
...
exports.NodeMock.prototype.store = function(endpoint, key, value, cb) {
    sendMessage(this._network._nodes[endpoint], 'store', endpoint,
                [key, value], cb);
};
...
exports.NodeMock.prototype.findNode = function(endpoint, id, cb) {
    sendMessage(this._network._nodes[endpoint], 'findNode', endpoint,
                [id], cb);
};
...
exports.NodeMock.prototype.findValue = function(endpoint, key, cb) {
    sendMessage(this._network._nodes[endpoint], 'findValue', endpoint,
                [key], cb);
};
